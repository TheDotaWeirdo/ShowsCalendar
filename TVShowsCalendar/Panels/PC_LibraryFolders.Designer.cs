namespace ShowsCalendar.Panels
{
	partial class PC_LibraryFolders
	{
		...
		private void InitializeComponent()
		{
			...
			this.B_SearchMedia = new SlickControls.Controls.SlickButton();
			...
			((System.ComponentModel.ISupportInitialize)(this.B_SearchMedia)).BeginInit();
			this.SuspendLayout();
			// 
			// TLP_Main
			// 
			...
			this.TLP_Main.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 47F));
			...
			this.B_Done.Location = new System.Drawing.Point(509, 395);
			...
			this.FLP_Folders.Size = new System.Drawing.Size(753, 303);
			...
			this.B_SearchMedia.IconSize = 16;
			this.B_SearchMedia.Image = global::ShowsCalendar.Properties.Resources.Tiny_Discover;
			this.B_SearchMedia.Location = new System.Drawing.Point(618, 395);
			...
			this.Controls.Add(this.B_SearchMedia);
			this.Controls.Add(this.TLP_Main);
			this.Name = "PC_LibraryFolders";
			this.Text = "Library Management";
			this.Controls.SetChildIndex(this.TLP_Main, 0);
			this.Controls.SetChildIndex(this.B_SearchMedia, 0);
			...
			((System.ComponentModel.ISupportInitialize)(this.B_SearchMedia)).EndInit();
		...
		private SlickControls.Controls.SlickButton B_SearchMedia;
	}
}
